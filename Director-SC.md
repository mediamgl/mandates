...
**Element** | **Value**
------------ | -------------
Function | This needs to be either **Customer Success** or **Marketing** as this domain will be responsible for individual development and growth.
Division | This role is aligned to the **Commercial** division.
Department | TBC
Team | This role is a member of the **Office of the CEO** team.
Reporting Line | This role *currently* reports to **Chief Executive Officer (CEO)**. <br> This reporting line should be revisited once the role mandate is complete.
...
------------ | -------------
Primary | This role is primarily aligned to the **Make our Customers Successful** North Star.
